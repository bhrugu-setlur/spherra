...
1. Read [`AGENTS.md`](AGENTS.md) for the living project guide and mandatory workflow.
2. Read the approved [production design](docs/superpowers/specs/2026-08-04-polar-lsm-router-design.md).
3. Read the approved [v1 implementation specification](docs/superpowers/specs/2026-08-04-polar-v1-implementation-spec.md).
4. Follow the active [codec and format foundation plan](docs/superpowers/plans/2026-08-04-polar-codec-format-foundation.md).
